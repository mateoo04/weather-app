...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,yCAAyC;AAC3C;;AAEA,iBAAiB;AACjB;;;;;;;;;;;;;;EAcE,SAAS;AACX;;AAEA;EACE,eAAe;EACf,cAAc;AAChB;;AAEA;;EAEE,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,kBAAkB;AACpB;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,eAAe;EACf,aAAa;AACf;;AAEA;EACE,sBAAsB;AACxB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,QAAQ;AACV;;AAEA;EACE,qBAAqB;EACrB,yBAAyB;AAC3B;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,eAAe;EACf,aAAa;EACb,sBAAsB;EACtB,QAAQ;EACR,aAAa;EACb,cAAc;EACd,aAAa;AACf;;AAEA;EACE,sBAAsB;EACtB,aAAa;EACb,aAAa;EACb,2CAA2C;EAC3C,mBAAmB;EACnB,mBAAmB;AACrB;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,mBAAmB;AACrB","sourcesContent":["* {\n  font-family: Arial, Helvetica, sans-serif;\n}\n\n/*Default styles*/\nbody,\nh1,\nh2,\nh3,\nh4,\np,\nul[class],\nol[class],\nli,\nfigure,\nfigcaption,\nblockquote,\ndl,\ndd {\n  margin: 0;\n}\n\nimg {\n  max-width: 100%;\n  display: block;\n}\n\nhtml,\nbody {\n  overflow: hidden;\n}\n\nheader {\n  display: flex;\n  justify-content: space-between;\n  padding: 14px 24px;\n}\n\n#location-input {\n  width: 300px;\n}\n\nmain {\n  display: flex;\n}\n\n.current-weather {\n  flex-basis: 40%;\n  padding: 16px;\n}\n\n.current-weather-icon {\n  width: max(256px, 40%);\n}\n\n.current-temp {\n  font-size: 3.6em;\n}\n\n.basic-info {\n  display: flex;\n  align-items: center;\n  gap: 8px;\n}\n\nul {\n  list-style-type: none;\n  padding-inline-start: 0px;\n}\n\n.bold {\n  font-weight: bold;\n}\n\n.ten-day-weather {\n  flex-basis: 60%;\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n  height: 100vh;\n  overflow: auto;\n  padding: 16px;\n}\n\n.day-item {\n  border: 1px solid #000;\n  padding: 10px;\n  display: grid;\n  grid-template-columns: 66px 1fr min-content;\n  align-items: center;\n  border-radius: 36px;\n}\n\n.day-item img {\n  height: 56px;\n}\n\n.temperature {\n  font-weight: bold;\n}\n\n.min-temp {\n  font-weight: normal;\n}\n"],"sourceRoot":""}]);
// Exports
...
module.exports = __webpack_require__.p + "d83c36bb31a3c8cd4fb7.svg";
